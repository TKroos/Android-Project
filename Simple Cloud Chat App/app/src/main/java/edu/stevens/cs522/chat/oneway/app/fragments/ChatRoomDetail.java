 ...
 */
public class ChatRoomDetail extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.chatroom_detail_fragment, container, false);
    }
    ...
    public Loader<Cursor> onCreateLoader(int loaderID, Bundle bundle) {
        if (getArguments() == null) return new CursorLoader(getActivity(), ChatProvider.MESSAGE_TABLE_URI, null, ChatProvider.CHATROOM + "=? and " + ChatProvider.MESSAGE + "!=?", new String[]{chatRoom, " "}, null);
        else {
            chatRoom = getArguments().getString(ARG_POSITION);
            return new CursorLoader(getActivity(), ChatProvider.MESSAGE_TABLE_URI, null, ChatProvider.CHATROOM + "=? and " + ChatProvider.MESSAGE + "!=?", new String[]{getArguments().getString(ARG_POSITION), " "}, null);
        }
    }
    ...
    public class ReceiveBroadCast extends BroadcastReceiver {
        ...
        public void onReceive(Context arg0, Intent intent) {
            if (intent.getStringExtra("receive_or_send").equals("receive")){
                lm.restartLoader(0, null, ChatRoomDetail.this);
            }
